...
export const DiscordSplash = () => {
    ...
    return (
        <div className={`fixed top-0 left-0 h-screen w-screen bg-background flex items-center justify-center p-4 z-[9999] pointer-events-none transition-opacity duration-500 ${show_splash ? "opacity-100" : "opacity-0"}`}>
